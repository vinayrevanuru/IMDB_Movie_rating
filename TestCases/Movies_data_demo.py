...
for genre in genres:
    ...
    for i in range(pages):
        ...
        for i in range(len(movies)):
            ...
            csv_writer.writerow([header_list[i],lista[i],listb[i],ratinglist[i],tvormovie[i],title_name,time_duration,genre,votes,reviews,meta,certificate,critics,creators_string,stars_string])
